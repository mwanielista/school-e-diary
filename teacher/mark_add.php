                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            ...
                            <form method="POST" action="includes/add_mark.inc.php"  class="form-horizontal">
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="hf-class" class=" form-control-label">Klasa</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" name="class" placeholder="Wprowadź klasę..." class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
                                            <label for="hf-name" name="class"class=" form-control-label">Przedmiot</label>
                                        </div>
                                        <div class="col-12 col-md-9">
                                            <input type="text" id="hf-name" name="przedmiot" placeholder="Wprowadź Przedmiot..." class="form-control">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3">
